...
SQL*Plus: Release 19.0.0.0.0 - Production on Sun Jan 3 02:23:10 2021
Version 19.3.0.0.0

Copyright (c) 1982, 2019, Oracle.  All rights reserved.

Last Successful login time: Sun Jan 03 2021 02:23:05 -05:00
...
|   0 | SELECT STATEMENT		  |		|   155 | 32550 |  1721
  (1)| 00:00:01 |

|   1 |  SORT ORDER BY			  |		|   155 | 32550 |  1721
  (1)| 00:00:01 |

|*  2 |   VIEW				  | VW_WIF_1	|   155 | 32550 |  1720
  (1)| 00:00:01 |

|   3 |    WINDOW SORT			  |		|   155 | 44485 |  1720
  (1)| 00:00:01 |

|*  4 |     HASH JOIN			  |		|   155 | 44485 |  1719
  (1)| 00:00:01 |

|   5 |      TABLE ACCESS FULL		  | NATION	|    25 |   800 |     3
  (0)| 00:00:01 |

|*  6 |      HASH JOIN			  |		|   774 |   192K|  1716
  (1)| 00:00:01 |

|   7 |       NESTED LOOPS		  |		|   774 | 85914 |  1647
  (1)| 00:00:01 |

|   8 |        NESTED LOOPS		  |		|   780 | 85914 |  1647
  (1)| 00:00:01 |

|   9 | 	MERGE JOIN CARTESIAN	  |		|   195 | 16575 |  1062
  (1)| 00:00:01 |

|* 10 | 	 TABLE ACCESS FULL	  | REGION	|     1 |    29 |     3
  (0)| 00:00:01 |

|  11 | 	 BUFFER SORT		  |		|   195 | 10920 |  1059
  (1)| 00:00:01 |

|* 12 | 	  TABLE ACCESS FULL	  | PART	|   195 | 10920 |  1059
  (1)| 00:00:01 |

|* 13 | 	INDEX RANGE SCAN	  | SYS_C007843 |     4 |	|     2
  (0)| 00:00:01 |

|  14 |        TABLE ACCESS BY INDEX ROWID| PARTSUPP	|     4 |   104 |     3
  (0)| 00:00:01 |

|  15 |       TABLE ACCESS FULL 	  | SUPPLIER	| 10000 |  1406K|    68
  (0)| 00:00:01 |
...
Version 19.3.0.0.0
# 02.sql:20210103022310:20210103022311:1609658591:1609658592:1 #
```
