...
SQL*Plus: Release 19.0.0.0.0 - Production on Sun Jan 3 03:47:19 2021
Version 19.3.0.0.0

Copyright (c) 1982, 2019, Oracle.  All rights reserved.

Last Successful login time: Sun Jan 03 2021 03:47:05 -05:00
...
|   0 | SELECT STATEMENT	 |	     | 15000 |	 717K|	     |	8759   (
1)| 00:00:01 |

|   1 |  SORT ORDER BY		 |	     | 15000 |	 717K|	     |	8759   (
1)| 00:00:01 |

|   2 |   HASH GROUP BY 	 |	     | 15000 |	 717K|	     |	8759   (
1)| 00:00:01 |

|   3 |    VIEW 		 | VM_NWVW_1 |	 111K|	5317K|	     |	8753   (
1)| 00:00:01 |

|   4 |     HASH GROUP BY	 |	     |	 111K|	  12M|	  13M|	8753   (
1)| 00:00:01 |

|*  5 |      HASH JOIN RIGHT ANTI|	     |	 111K|	  12M|	     |	5809   (
1)| 00:00:01 |

|*  6 |       TABLE ACCESS FULL  | SUPPLIER  |	 500 | 34000 |	     |	  68   (
0)| 00:00:01 |

|*  7 |       HASH JOIN 	 |	     |	 116K|	5711K|	     |	5741   (
1)| 00:00:01 |

|*  8 |        TABLE ACCESS FULL | PART      | 29531 |	1182K|	     |	1061   (
1)| 00:00:01 |

|   9 |        TABLE ACCESS FULL | PARTSUPP  |	 800K|	7031K|	     |	4677   (
1)| 00:00:01 |
...
Version 19.3.0.0.0
# 16.sql:20210103034719:20210103034724:1609663640:1609663645:5 #
```
